...
@section('title') Page Group @endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Page Group list)</h3>
                </div>
                        ...
                        @forelse($pageGroups as $pageGroup)
                            <tr>
                                ...
                                <td>{{$pageGroup->name}} <br>
                                    Total Page) {{$pageGroup->pages->count()}}</td>
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu  dropdown-menu-right p-2" role="menu">
                                            ...
                                            <li><a href="#!" class="nav-link text-black"
                                                   onclick="confirm_modal('{{ route('pages.group.destroy', $pageGroup->id) }}')">Delete)</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Page Group create</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body p-2">
